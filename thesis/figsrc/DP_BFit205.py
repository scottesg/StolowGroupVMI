...
data = np.load("DP_BFit205_mpolAs4.500rcM.npz")
K = np.load("DP_BFit205_KAs.npy")
...
t1 = ax1.text(pos1, pos2-0.01, '(a)', ha='left', va='top', color=col1, transform=ax1.transAxes, fontsize=letsize)
...
t2 = ax2.text(pos1, pos2-0.01, '(b)', ha='left', va='top', color=col1, transform=ax2.transAxes, fontsize=letsize)
...
t3 = ax3.text(pos1, pos2-0.01, '(c)', ha='left', va='top', color=col1, transform=ax3.transAxes, fontsize=letsize)
...
t5 = ax5.text(pos1-0.02, pos2-0.01, '(e)', ha='left', va='top', color=col1, transform=ax5.transAxes, fontsize=letsize)
...
t6 = ax6.text(pos1-0.02, pos2-0.01, '(f)', ha='left', va='top', color=col1, transform=ax6.transAxes, fontsize=letsize)
...
im4 = ax4.pcolor(PHI[:,:,argp], THETA[:,:,argp], 2*sphere/sphere.max(), cmap="seismic", vmax=1, vmin=0)
...
cbar4 = plt.colorbar(im4, ax=ax4, fraction=0.10, pad=0.04)
cbar4.ax.tick_params(labelsize=FSlg)

t4 = ax4.text(pos1, pos2+0.01, '(d)', ha='left', va='top', color=col1, transform=ax4.transAxes, fontsize=letsize)
