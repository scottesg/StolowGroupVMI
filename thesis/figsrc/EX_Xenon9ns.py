...
pts = np.load("EX_Xenon9ns_20210923_T6.pt.npy")
coords = plt.imread("EX_Xenon9ns_Axes.png")
...
d = 120 # Radius around centre to show
r = 80 # Radius of ring
...
ani.save("EX_Xenon9ns_Movie.mp4", bitrate=20000)
