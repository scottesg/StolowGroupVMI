...
datapath = r"C:\Users\Scott\Python\VMI\data\20240418_VMI3DPaperData2\266/1CH_154004_154649/"
...
covshuffle = False # shuffle based covariance method
undogridscale = False
...
paths = ["266_20231213_154004/data{}P_NC.npy".format(name), "266_20231213_154649/data{}P_NC.npy".format(name)]

for i in range(len(paths)):
    a = np.array(np.load(loadpath + paths[i]))
    if i==0: pt=a
