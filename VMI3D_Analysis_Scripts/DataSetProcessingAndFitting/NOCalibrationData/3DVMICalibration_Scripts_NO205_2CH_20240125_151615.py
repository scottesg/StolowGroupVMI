...
datapath = r"C:\Users\Scott\Python\VMI\data\20240418_VMI3DPaperData2\213/213_20240125_151615/"
ke = 2.05  # eV, energy of ring
t0 = 2086.4-1.67  # ns, centre tof
T0 = 29.5  # ns, put centre here
cen = [255.75, 238]  # xy centre
rotangle = 29.6*np.pi/180  # xy rotation angle (camera not aligned)
...
paths = [loadpath + "213_20240125_151615/"]
