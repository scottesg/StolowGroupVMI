...
datapath = r"C:\Users\Scott\Python\VMI\data\20240418_VMI3DPaperData2\213266/213266_20231213_162638/"
ke = 0.88  # eV, energy of ring
keinner = 0.052
t0 = 8.1 # ns, centre tof
T0 = 29.5 # ns, put centre here
cen = [255.75, 238] # xy centre
rotangle = 26.8*np.pi/180 # xy rotation angle (camera not aligned)
...
paths = [loadpath+"213266_20231213_162638/"]

#%% Load data, shift and trim

for i in range(len(paths)):
    a = np.load(paths[i] + "dataS.npy")
    if undogridscale:
