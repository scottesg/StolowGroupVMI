...
datapath = r"C:\Users\Scott\Python\VMI\data\20240418_VMI3DPaperData2\213266/1CH_160902_161613_162638/"
path1 = "mpolSs000.npz"
...
ax1.fill_between([180+angfit-dang, 180+angfit+dang], 0, 1, color='black', alpha=0.5,
                 label="$\chi_{z}$ = %2.1f$\N{DEGREE SIGN}\pm$%2.1f\N{DEGREE SIGN}"%(angfit, dang))
...
ax1.text(.02, .98, '(a)', ha='left', va='top', transform=ax1.transAxes, fontsize=20)
...
ax2.fill_between([180+angfit-dang, 180+angfit+dang], 0, 1, color='black', alpha=0.5,
                 label="$\chi_{y}$ = %2.1f$\N{DEGREE SIGN}\pm$%2.1f\N{DEGREE SIGN}"%(angfit, dang))
...
ax2.text(.02, .98, '(b)', ha='left', va='top', transform=ax2.transAxes, fontsize=20)