...
datapath = r"C:\Users\Scott\Python\VMI\data\20240418_VMI3DPaperData2\266/266_20240207_140639/"
ke = 0.054 # eV, energy of ring
t0 = 2086.5 # ns, centre tof
T0 = 29.5 # ns, put centre here
cen = [255.75, 238] # xy centre
rotangle = 28.9*np.pi/180 # xy rotation angle (camera not aligned)
...
paths = [loadpath + "266_20240207_140639/"]
