...
datapath = r"C:\Users\Scott\Python\VMI\data\20240418_VMI3DPaperData2\Fig4ErrorsData/3day/"
name = 'As'
...
fitpol = np.load(datapath + "calpoly{}.npy".format(name))
fitpol = np.poly1d(fitpol)
...
ax1.pcolor(PZ, PT, (gaussian_filter(H,5)/PT).T, cmap="Grays", vmax=8)
ax1.set_xticklabels([])
...
#ax1.vlines((-0.36, 0.25), prmin, prmax, ls=':', lw=2, color='k')
...
# cmapblue = mpl.cm.Blues(255)
# blue05 = list(cmapblue)
# blue05[-1] = 0.2
