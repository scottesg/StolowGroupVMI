...
if ~i0 
    ...
    if (X(1)<X(n))  % ascending
        if (X(1)>x0), i0=1; else i0=n; end;
    else            %descending
        %if (X(n)>x0), i0=n; else i0=1; end;
        if (X(n)>=x0), i0=n; else i0=1; end; % to accomodate cases like X=[3,2,1,0]; and x0=0; %ab20150512        
    end;
