...
class TRPES_simulator(QMainWindow,Ui_TRPES_simulator):
    ...
    def plot_TRPES(self, viewer,z,x,y):
        ...
        try:
            if self.display_log_t==True:
                ...
                #add the colormap
                colormap = colormaps["nipy_spectral"]  # cm.get_cmap("CMRmap")
    ...
    def plot_TRPES_normally(self, viewer, z,x,y):
        ...
        viewer.clear()
        p1 = viewer.addPlot()
        self.filterMenu = QtWidgets.QMenu("Logharithmic Scale")
        self.change_to_logharithmic = QtWidgets.QAction("Change x-axis to logarithmic", self.filterMenu,checkable=True,checked=self.display_log_t)
        self.change_to_logharithmic.triggered.connect(lambda: self.change_viewer_scale_to_log(self.change_to_logharithmic.isChecked()))
        self.filterMenu.addAction(self.change_to_logharithmic)
        p1.ctrlMenu=[self.filterMenu]
        ...
        y_factor=size_y/y3.shape[0]
        tr = QtGui.QTransform()
        tr.translate(x3.min(), y3.min())
        tr.scale(x_factor, y_factor)
        img.setTransform(tr)
    ...
    def initialize_global_graphs(self):
        ...
        self.filterMenu2 = QtWidgets.QMenu("Normalize")
        self.normalize = QtWidgets.QAction("Normalize the DAS", self.filterMenu2,checkable=True,checked=False)
    ...
    def initalize_global_graphs_bidir(self):
        ...
        self.filterMenu3 = QtWidgets.QMenu("Normalize")
        self.normalize2 = QtWidgets.QAction("Normalize the DAS", self.filterMenu3,checkable=True,checked=False)
